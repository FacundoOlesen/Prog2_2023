...
import TP9.EJ_2.Comparadores.ComparadorTamanio;
import TP9.EJ_2.Condiciones.CondicionNOT;
import TP9.EJ_2.Condiciones.CondicionNombre;
import TP9.EJ_2.Condiciones.CondicionTamanio;
...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println(raiz.getArchivosQueCumplenOrdenados(new CondicionTamanio(500), null));
        System.out.println("Archivos cuyo nombre contenga r, ordenado por tamanio");
        System.out.println(raiz.getArchivosQueCumplenOrdenados(new CondicionNombre("r"), new ComparadorTamanio()));
        System.out.println("Archivos de tamanio MAYOR o igual a 500, ordenados por tamaño descendente");
        System.out.println(raiz.getArchivosQueCumplenOrdenados(
                new CondicionNOT(new CondicionTamanio(500)), new ComparadorTamanio().reversed()));
